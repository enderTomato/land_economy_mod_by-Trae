---
name: "forge-mod-dev"
description: "Minecraft Forge 1.20.1 模组开发全流程经验。Invoke when user asks to create, modify, or refactor a Forge 1.20.1 mod, encounters build errors, or needs guidance on Forge API (GuiGraphics, networking, config, events)."
---

# Minecraft Forge 模组开发全流程经验
